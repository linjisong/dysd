...
/**
 * SqlSessionFactory工厂，在mybatis-spring基础之上重构
 * @author linjisong
 * @version 0.0.1
 * @date 2016-11-12
 */
public class SqlSessionFactoryBean
	...
	public void afterPropertiesSet() throws Exception {
		...
		if(null == this.sqlSessionFactoryBuilder){
			this.sqlSessionFactoryBuilder = MybatisComponents.newSqlSessionFactoryBuilder();
		}
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		doCustomConfiguration(configuration);
	...
	protected ConfigurationWrapper doGetConfigurationWrapper() throws IOException {
		...
		if (this.configuration != null) {
			...
			xmlConfigBuilder = MybatisComponents.newXMLConfigBuilder(this.configLocation.getInputStream(), null,
			...
			configuration = MybatisComponents.newConfiguration();
			configuration.setVariables(this.configurationProperties);
		}
	...
	protected void doResolveEnvironment(Configuration configuration) {
		configuration.setEnvironment(MybatisComponents.newEnvironment(this.environment, this.transactionFactory, this.dataSource));
	}

	protected void doResolveTransactionFactory() {
		if (this.transactionFactory == null) {
			this.transactionFactory = MybatisComponents.newTransactionFactory();
		}
	}

	protected void doResolveCache(Configuration configuration) {
		if (this.cache != null) {
			configuration.addCache(this.cache);
		}
	}

	protected void doResolveObjectFactory(Configuration configuration) {
		if (this.objectFactory != null) {
			configuration.setObjectFactory(this.objectFactory);
		}
	}

	protected void doResolveObjectWrapperFactory(Configuration configuration) {
		if (this.objectWrapperFactory != null) {
			configuration.setObjectWrapperFactory(this.objectWrapperFactory);
		}
	}

	protected void doResolveVfs(Configuration configuration) {
		if (this.vfs != null) {
			configuration.setVfsImpl(this.vfs);
		}
	}

	protected void doResolveTypeAliasesPackage(Configuration configuration) {
	...
	protected void doResolveTypeAliases(Configuration configuration) {
	...
	protected void doResolvePlugins(Configuration configuration) {
	...
	protected void doResolveTypeHandlersPackage(Configuration configuration) {
	...
	protected void doResolveTypeHandlers(Configuration configuration) {
	...
	protected void doResolveDatabaseIdProvider(Configuration configuration) throws NestedIOException {
	...
	protected void doParseConfig(XMLConfigBuilder xmlConfigBuilder) throws NestedIOException {
	...
	protected void doParseSqlMapper(Configuration configuration) throws NestedIOException {
		if (!isEmpty(this.mapperLocations)) {
			for (Resource mapperLocation : this.mapperLocations) {
				...
				doParseSqlMapperResource(configuration, mapperLocation);
				if (LOGGER.isDebugEnabled()) {
	...
	protected void doParseSqlMapperResource(Configuration configuration, Resource mapperLocation)
		...
		try {
			XMLMapperBuilder xmlMapperBuilder = MybatisComponents.newXMLMapperBuilder(mapperLocation.getInputStream(),
